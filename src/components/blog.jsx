				...
				<section className="colorlib-blog" data-section="blog">
					<div className="colorlib-narrow-content">
						...
						<div className="row">
							...
							<div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
								<div className="blog-entry">
									<a href="https://medium.com/@vigneshwaran.03.10/angular-vs-react-vs-vue-a77645361ada" className="blog-img"><img src="images/blog4.jpg" className="img-responsive" alt="" /></a>
									<div className="desc">
